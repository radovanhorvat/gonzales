...
def test_brute_force_basic():
    ...
    accs = kernbf.calculate_accs_pp(space.r, space.m, G, eps)
    ...
    # 1.3. set G = 0
    accs = kernbf.calculate_accs_pp(space.r, space.m, 0., eps)
...
def test_barnes_hut_theta_zero_C():
    ...
    for num in particle_nums:
        ...
        accs1 = kernbf.calculate_accs_pp(space.r, space.m, G, eps)
        accs2 = kernoct_c.calc_accs_octree(cube_length, 0., 0., 0., space.r, space.m, G, eps, theta)
...
def test_barnes_hut_theta_non_zero_C():
    ...
    for num in particle_nums:
        ...
        space = Space()
        space.add_cuboid(num, np.array((0., 0., 0.)), cube_length, cube_length, cube_length, vel_func, mass_func)
        accs2 = kernbf.calculate_accs_pp(space.r, space.m, G, eps)
        accs3 = kernoct_c.calc_accs_octree(cube_length, 0., 0., 0., space.r, space.m, G, eps, theta)
